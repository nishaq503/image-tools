...
from polus.transforms.images.roi_relabel import methods
...
def draw_plots(
    ...
    for method in methods.METHODS:
        ...
        methods.relabel(image_path, out_path, method, range_multiplier=2.0)
    ...
    fig, ((ax_00, ax_01), (ax_10, ax_11), (ax_20, ax_21)) = pyplot.subplots(
        3, 2, figsize=(10, 15), dpi=300
    )
...
def main():
    ...
    input_dir = DATA_ROOT.joinpath("input").resolve()
